...
export const MASCOTS: MascotDef[] = [
  { id: "bird", nazev: "Oranžový ptáček t!", nameEn: "Orange bird t!", duration: 8000, component: Bird, demoText: "Schůzka za 5 minut", demoTextEn: "Meeting in 5 minutes",
  ...
  { id: "paperplane", nazev: "Papírová vlaštovka", nameEn: "Paper plane", duration: 8000, component: Paperplane, demoText: "Standup teď", demoTextEn: "Standup now",
  ...
  { id: "plane", nazev: "Letadélko s transparentem", nameEn: "Plane with a banner", duration: 9000, component: Plane, demoText: "Porada s vedením · za 5 min", demoTextEn: "Leadership sync · in 5 min",
  ...
  { id: "cat", nazev: "Kocour", nameEn: "Cat", duration: 10000, component: Cat, demoText: "Meeting!", demoTextEn: "Meeting!",
  ...
  { id: "drone", nazev: "Dron s balíčkem", nameEn: "Delivery drone", duration: 9000, component: Drone, demoText: "14:00 · Standup", demoTextEn: "2:00 PM · Standup",
  ...
  { id: "robot", nazev: "Robot poslíček", nameEn: "Courier robot", duration: 10000, component: Robot, demoText: "Schůzka za 2 min", demoTextEn: "Meeting in 2 min",
  ...
  { id: "formula", nazev: "Formule", nameEn: "Formula car", duration: 6000, component: Formula, demoText: "Jdeš pozdě!", demoTextEn: "You are late!",
  ...
  { id: "balloon", nazev: "Balón s košem", nameEn: "Hot-air balloon", duration: 14000, component: Balloon, demoText: "Za 10 minut call", demoTextEn: "Call in 10 minutes",
  ...
  { id: "flock", nazev: "Hejno ptáků", nameEn: "Bird flock", duration: 7000, component: Flock, demoText: "TEĎ", demoTextEn: "NOW",
  ...
  { id: "pixel", nazev: "Pixel-art pták", nameEn: "Pixel-art bird", duration: 8000, component: Pixel, demoText: "TEĎ!", demoTextEn: "NOW!",
